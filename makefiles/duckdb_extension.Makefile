...
clangd: ${EXTENSION_CONFIG_STEP}
	...
	cmake $(GENERATOR) $(BUILD_FLAGS) $(EXT_DEBUG_FLAGS) $(VCPKG_MANIFEST_FLAGS) -DCMAKE_BUILD_TYPE=Debug -S $(DUCKDB_SRCDIR) -B build/clangd
...
set_duckdb_repository:
	rm -rf duckdb
	mkdir duckdb
	git clone $(DUCKDB_GIT_REPOSITORY) duckdb
